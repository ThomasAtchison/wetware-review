...
#import "FavoritePartsController.h"

#define kCellIdentifier @"edu.stanford.bioeng.endylab.BioBrickStudio.FavoritePartSelectionCellIdentifier"

@implementation FavoritePartsController
...
{	
	...
	{		
		alertView = [[UIAlertView alloc] initWithTitle:@"Error" 
											   message:@"There was an error while retrieving data from the Registry of Standard Biological Parts." 
											  delegate:nil 
